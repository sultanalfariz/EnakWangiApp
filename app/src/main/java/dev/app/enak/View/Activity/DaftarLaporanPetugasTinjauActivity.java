...
public class DaftarLaporanPetugasTinjauActivity extends AppCompatActivity implements ListLaporanPetugasMvp {

    RecyclerView rvLaporan;
    TextView txtKosong;

    ListLaporanPetugasPresenter listLaporanPetugasPresenter;
    ListLaporanPetugasTinjauAdapter listLaporanPetugasTinjauAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_laporan_petugas_tinjau);

        listLaporanPetugasPresenter = new ListLaporanPetugasImpl(this);

        listLaporanPetugasPresenter.listLaporanTinjau();
    ...
    public void LoadLaporanTinjau(List<ListLaporanResource> listLaporanResource) {
        pDialog.dismiss();
        listLaporanPetugasTinjauAdapter = new ListLaporanPetugasTinjauAdapter(this, listLaporanResource, this);
        rvLaporan.setAdapter(listLaporanPetugasTinjauAdapter);
        listLaporanPetugasTinjauAdapter.notifyDataSetChanged();
    }
