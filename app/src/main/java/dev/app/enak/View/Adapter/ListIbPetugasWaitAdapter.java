...
import dev.app.enak.View.Activity.TanggapiIbActivity;
import dev.app.enak.View.Activity.TanggapiLaporanActivity;

public class ListIbPetugasWaitAdapter extends RecyclerView.Adapter<ListIbPetugasWaitAdapter.ListIbPetugasWaitViewHolder> {

    List<ListIbResource> listIbResources;
    Context context;
    LayoutInflater layoutInflater;
    DaftarIbPetugasWaitActivity activity;

    public ListIbPetugasWaitAdapter(Context context, List<ListIbResource> listIbResources, DaftarIbPetugasWaitActivity activity){
    ...
    @NonNull
    @Override
    public ListIbPetugasWaitAdapter.ListIbPetugasWaitViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_laporan_pemilik,parent,false);
        ListIbPetugasWaitAdapter.ListIbPetugasWaitViewHolder holder = new ListIbPetugasWaitAdapter.ListIbPetugasWaitViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull ListIbPetugasWaitAdapter.ListIbPetugasWaitViewHolder holder, int position) {
...
//        holder.txtStatus.setText(listLaporanResources.get(position).getStatus());
        ...
        if (listIbResources.get(0).getStatus().equals("Belum Ditanggapi")){
        ...
        holder.cardLaporan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, TanggapiIbActivity.class);
    ...
    public class ListIbPetugasWaitViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListIbPetugasWaitViewHolder(@NonNull View itemView) {
            super(itemView);
