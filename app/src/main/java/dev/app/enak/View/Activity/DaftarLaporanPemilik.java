...
public class DaftarLaporanPemilik extends AppCompatActivity implements ListLaporanPemilikMvp {
    ...
    ListLaporanPemilikAdapter listLaporanPemilikAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_laporan_pemilik);
        ...
        listLaporanPemilikPresenter.listLaporan(id_pemilik);
        ...
        btnRiwayat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DaftarLaporanPemilik.this, RiwayatLaporanPemilik.class);
    ...
    public void LoadLaporan(List<ListLaporanResource> listLaporanResources) {
        pDialog.dismiss();
        listLaporanPemilikAdapter = new ListLaporanPemilikAdapter(this, listLaporanResources, this);
        rvLaporan.setAdapter(listLaporanPemilikAdapter);
        listLaporanPemilikAdapter.notifyDataSetChanged();
    }
