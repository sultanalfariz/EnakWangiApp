...
public class ListIbPetugasProsesAdapter  extends RecyclerView.Adapter<ListIbPetugasProsesAdapter.ListIbPetugasProsesViewHolder> {

    List<ListIbResource> listIbResources;
    Context context;
    LayoutInflater layoutInflater;
    DaftarIbPetugasProsesActivity activity;

    public ListIbPetugasProsesAdapter(Context context, List<ListIbResource> listIbResources, DaftarIbPetugasProsesActivity activity){
    ...
    @NonNull
    @Override
    public ListIbPetugasProsesAdapter.ListIbPetugasProsesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_laporan_pemilik,parent,false);
        ListIbPetugasProsesAdapter.ListIbPetugasProsesViewHolder holder = new ListIbPetugasProsesAdapter.ListIbPetugasProsesViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull ListIbPetugasProsesAdapter.ListIbPetugasProsesViewHolder holder, int position) {
...
//        holder.txtStatus.setText(listLaporanResources.get(position).getStatus());
        ...
        if (listIbResources.get(0).getStatus().equals("Dalam Proses")){
    ...
    public class ListIbPetugasProsesViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListIbPetugasProsesViewHolder(@NonNull View itemView) {
            super(itemView);
